...
-   [Notion](https://www.notion.so/) - NotionÂ is aÂ note-takingÂ andÂ collaborationÂ application withÂ markdownÂ support that also integrates tasks, wikis, and databases. The company describes the app as an all-in-one workspace for note-taking, project management and task management. In addition to cross-platform apps, it can be accessed via mostÂ web browsers.
...
-   [mail.gw](https://mail.gw) â 10 Minute Mail. Free anonymous temporary email without obligations.
-   [mail.tm](https://mail.tm) â Disposable e-mail with user friendly interface. No registration needed.
...
-   [mailmenot.io](https://mailmenot.io) â Free disposable temporary email service with ability to add multiple email addresses
...
-   [mohmal.com](https://www.mohmal.com/en) â Disposable temporary email
...
-   [temp-mail.org](https://temp-mail.org) â Temporary, secure, anonymous, free, disposable email address with REST API for fetching 100 emails from its disposable mailbox per day for free.
-   [Temp Mail](https://tempmailers.com) â Temporary, disposable, private domain, and free email system.
...
-   [yopmail.fr](https://www.yopmail.fr/en/) â Disposable email addresses
...
-   [bit.io](https://bit.io) â Managed PostgreSQL database service. 1 database, 10GB storage, 1 CPU and 1GB Memory (burst).
...
-   [internxt.com](https://internxt.com) â Internxt Drive is a zero-knowledge file storage service that's based on absolute privacy and uncompromising security. Sign up and get 2 GB for free, forever!
...
-   [Screenshots](https://screenshotson.click) â You API for Screenshot. With highly customizable options for capture. Free 100 screenshots/month.
...
-   [Themeselection](https://themeselection.com/) â Selected high quality, modern design, professional and easy-to-use Free Admin Dashboard Template,
